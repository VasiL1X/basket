<template>
    <div>
        ...
        <div class="account__content">
            <div class="account__content-common info_cridt">
        ...
        <div class="add_card_infos add-card-infos-div">
            <ul>
                <li>
                    <button type="button" class="btn btn-danger" data-toggle="modal" data-target="#addNewCard">New card</button>
                </li>
            </ul>
        </div>
        <div class="account__content">
            <div v-for="item in cardLists" class="account__content-common info_cridt">
                <div class="credit-card-info">
                    <p class="centered curr_card_text">
                        <strong>
                        ...
                        </strong></p><div id="card_btn" style="display: inline-block"><strong>
                    <div class="dropdown">
                        <button @click="showDropDown(item.card_id, open)" class="dropbtn">...
                        </button>
                        <div :id="'myDropdown_'+item.card_id" class="dropdown-content">
                            <a href="javascript:void(0)" @click="deleteCard(item.card_id)" >Delete</a>
                            <a href="javascript:void(0)" @click="updateLabel(item)">Update
                                label</a>
                            <a href="javascript:void(0)" @click="makeDefault(item.card_id)"> Make default </a>
                        </div>
                    </div>
                </strong></div>
                    <strong>
