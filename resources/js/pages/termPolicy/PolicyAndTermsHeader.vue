<template>
    <div>
        <div class="privacy_policy_sctions_outer">
            <div class="privacy_policy_sctions">
                <div class="container-fluid">
                    <div class="logoHeader">
                        <router-link :to="{ name: 'login' }"  title="Basket">
                            <img width="140" src="images/logo-white.png" alt="">
                        </router-link>
                    </div>
