                            ...
                            <div class="col-md-8">
                                <div class="right_helps_text">
                                    <p class="term_txt">The <a href="/terms-conditions" target="_blank">
                                        Basket Terms of Service </a> apply for any and all Basket Orders, Promotions,
                                        Credits, Refunds, and Possible Returns.
                                        In addition, the following additional terms apply with respect to the specific
                                        matters below</p>
                                    <br>
                                    <div class="inner_text_info show_help" v-if="detail.id == selectedQuestionId"
                                         v-for="detail in helpDetails">
                                        <div class="text">
                                            <img class="helps_imgs" src="/images/account_settings-01.png" alt="">
                                            {{detail.question}}
                                        </div>
